...
const HomePage = () => {
    ...
    return (
        <>
            {/* Hero Section */}
            <section className="min-h-screen bg-gradient-to-br flex items-center justify-center from-blue-600 via-purple-600 to-purple-700 text-white pt-32 pb-20 px-6 relative overflow-hidden">
